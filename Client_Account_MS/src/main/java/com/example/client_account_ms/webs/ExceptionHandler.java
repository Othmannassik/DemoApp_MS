...
import com.example.client_account_ms.exceptions.*;
...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(value = {
            AccountNotFoundException.class, ClientNotFoundException.class,
            InsufficientBalanceException.class, ClientAlreadyExistException.class, ClientWithAccountException.class
    })
